...
class TargetClass:
    ...
    def __init__(self, filename, module, name):
        ...
        self.name = name
        self.methods = {}
        self.add_special_methods()

    def add_special_methods(self):
        self.add_method('__len__')
        self.add_method('__length_hint__')
        self.add_method('__iter__')
        self.add_method('__reversed__')
        self.add_method('__neg__')
        self.add_method('__pos__')
        self.add_method('__abs__')
        self.add_method('__invert__')
        self.add_method('__complex__')
        self.add_method('__int__')
        self.add_method('__float__')
        self.add_method('__round__')
        self.add_method('__index__')
        self.add_method('__enter__')
        self.add_method('__await__')
        self.add_method('__aiter__')
        self.add_method('__anext__')
        self.add_method('__aenter__')
        self.add_method('__aexit__')
        self.add_method_with_params('__getitem__', ParameterType.any_object)
        self.add_method_with_params('__missing__', ParameterType.any_object)
        self.add_method_with_params('__delitem__', ParameterType.any_object)
        self.add_method_with_params('__contains__', ParameterType.any_object)
        self.add_method_with_params('__add__', ParameterType.any_object)
        self.add_method_with_params('__sub__', ParameterType.any_object)
        self.add_method_with_params('__mul__', ParameterType.any_object)
        self.add_method_with_params('__matmul__', ParameterType.any_object)
        self.add_method_with_params('__truediv__', ParameterType.any_object)
        self.add_method_with_params('__floordiv__', ParameterType.any_object)
        self.add_method_with_params('__mod__', ParameterType.any_object)
        self.add_method_with_params('__divmod__', ParameterType.any_object)
        self.add_method_with_params('__pow__', ParameterType.any_object)
        self.add_method_with_params('__lshift__', ParameterType.any_object)
        self.add_method_with_params('__rshift__', ParameterType.any_object)
        self.add_method_with_params('__and__', ParameterType.any_object)
        self.add_method_with_params('__xor__', ParameterType.any_object)
        self.add_method_with_params('__or__', ParameterType.any_object)
        self.add_method_with_params('__radd__', ParameterType.any_object)
        self.add_method_with_params('__rsub__', ParameterType.any_object)
        self.add_method_with_params('__rmul__', ParameterType.any_object)
        self.add_method_with_params('__rmatmul__', ParameterType.any_object)
        self.add_method_with_params('__rtruediv__', ParameterType.any_object)
        self.add_method_with_params('__rfloordiv__', ParameterType.any_object)
        self.add_method_with_params('__rmod__', ParameterType.any_object)
        self.add_method_with_params('__rdivmod__', ParameterType.any_object)
        self.add_method_with_params('__rpow__', ParameterType.any_object)
        self.add_method_with_params('__rlshift__', ParameterType.any_object)
        self.add_method_with_params('__rrshift__', ParameterType.any_object)
        self.add_method_with_params('__rand__', ParameterType.any_object)
        self.add_method_with_params('__rxor__', ParameterType.any_object)
        self.add_method_with_params('__ror__', ParameterType.any_object)
        self.add_method_with_params('__iadd__', ParameterType.any_object)
        self.add_method_with_params('__isub__', ParameterType.any_object)
        self.add_method_with_params('__imul__', ParameterType.any_object)
        self.add_method_with_params('__imatmul__', ParameterType.any_object)
        self.add_method_with_params('__itruediv__', ParameterType.any_object)
        self.add_method_with_params('__ifloordiv__', ParameterType.any_object)
        self.add_method_with_params('__imod__', ParameterType.any_object)
        self.add_method_with_params('__ipow__', ParameterType.any_object)
        self.add_method_with_params('__ilshift__', ParameterType.any_object)
        self.add_method_with_params('__irshift__', ParameterType.any_object)
        self.add_method_with_params('__iand__', ParameterType.any_object)
        self.add_method_with_params('__ixor__', ParameterType.any_object)
        self.add_method_with_params('__ior__', ParameterType.any_object)
        self.add_method_with_params('__setitem__', ParameterType.any_object, ParameterType.any_object)
